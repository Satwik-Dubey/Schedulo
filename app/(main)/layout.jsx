      ...
      <div className="flex flex-col h-screen bg-green-50 md:flex-row">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          <header className="flex justify-between items-center mb-4">
            <h2 className="text-5xl md:text-6xl font-extrabold bg-gradient-to-br from-green-600 to-green-400 bg-clip-text tracking-tighter text-transparent pb-4 pr-2 pt-2 md:pt-0 text-center md:text-left w-full">
